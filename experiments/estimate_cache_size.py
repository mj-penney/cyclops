...
def sweep_array_size_kib(lo: int, hi: int, step: int, metric_grp: str):
...
def fig_3_run_experiment():
    sweep_array_size_kib(10, 2800, 20, "TASK_CLOCK_NS")
    os.rename("param_sweep.csv", "fig_3.csv")

def latency_plot_make_fig():
